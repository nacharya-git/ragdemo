...
# installed.
TK_PREFIX='/Users/nrusinghaprasadacharya/agenticai/ragdemo/venv'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/Users/nrusinghaprasadacharya/agenticai/ragdemo/venv'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/Users/nrusinghaprasadacharya/agenticai/ragdemo/venv/lib -ltcl9tk9.0'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/Users/nrusinghaprasadacharya/agenticai/ragdemo/venv/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/Users/nrusinghaprasadacharya/agenticai/ragdemo/venv/lib -ltkstub'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/Users/ec2-user/croot/tk_1786632483285/work/tk9.0.4/unix/libtkstub.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/Users/nrusinghaprasadacharya/agenticai/ragdemo/venv/lib/libtkstub.a'

# Top-level directory in which Tk's demo files are installed.
TK_DEMO_DIR='/Users/nrusinghaprasadacharya/agenticai/ragdemo/venv/lib/tk9.0/demos'
